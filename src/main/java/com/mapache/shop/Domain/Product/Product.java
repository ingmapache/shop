...
public class Product {
    ...
    public Product(Long incId, ProductName incproductName, Brand incProductBrand, ProductDescription incProductDescription, Money incProductPrice, List<Image> incProductImages)
    {
